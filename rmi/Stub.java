...
public abstract class Stub
{
    ...
    public static <T> T create(Class<T> c, Skeleton<T> skeleton) throws UnknownHostException {
        ...
        boolean startStatus = skeleton.start;
        if(c == null || skeleton == null) {
            throw new NullPointerException("Object is null");
        }
        if(socketAddress == null && skeleton.start == false) {
            throw new IllegalStateException("Skeleton has not been assigned an address by the user " +
